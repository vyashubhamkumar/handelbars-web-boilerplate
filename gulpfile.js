...
gulp.task('styles', function() {
	...
	return gulp.src('src/assets/styles/**/*.*')
		.pipe(autoprefixer())
...
gulp.task('vendors', function() {
	return gulp.src('src/assets/vendors/**/*.*', {since: gulp.lastRun('vendors')})
	.pipe(newer('dist/vendors'))
...
gulp.task('build', gulp.series(
	'clean', gulp.parallel('styles', 'img', 'fonts', 'vendors', 'js', 'handlebars'))
);
...
gulp.task('watch', function() {
	...
	gulp.watch('src/assets/vendors/**/*.*', gulp.series('vendors'));
